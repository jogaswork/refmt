...
# ID премиум-эмодзи для сообщения «Наши чаты» / инфо о проекте.
# Fallback-символ внутри тега — 💬.
OUR_CHATS_EMOJI_ID = "5870886806601338791"
...
async def our_chats(message: Message) -> None:
    """Показ информации о проекте (кнопка «💬 Наши чаты» в главном меню)."""
    text = (
        f'<tg-emoji emoji-id="{OUR_CHATS_EMOJI_ID}">💬</tg-emoji> Информация о проекте MTR\n'
